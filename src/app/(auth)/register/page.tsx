          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                ...
                <option value="jongere">Jongere (16-18)</option>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-primary text-white font-bold py-4 rounded-xl hover:opacity-90 active:scale-[0.98] transition-all shadow-lg shadow-primary/20 mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
